...
CREATE TABLE `wp_addons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=65 DEFAULT CHARSET=utf8 COMMENT='插件表';
...
INSERT INTO `wp_addons` VALUES ('18', 'Wecome', '欢迎语', '用户关注公众号时发送的欢迎信息，支持文本，图片，图文的信息', '1', '{\"type\":\"1\",\"title\":\"\",\"description\":\"欢迎关注，请<a href=\"[follow]\">绑定账号</a>后体验更多功能\",\"pic_url\":\"\",\"url\":\"\"}', '地下凡星', '0.1', '1389620372', '0', '1', '2');
INSERT INTO `wp_addons` VALUES ('19', 'UserCenter', '微信用户中心', '实现3G首页、微信登录，微信用户绑定，微信用户信息初始化等基本功能', '1', '{\"random\":\"1\"}', '地下凡星', '0.1', '1390660425', '1', '1', '2');
INSERT INTO `wp_addons` VALUES ('23', 'HelloWorld', '微信示列', '这是一个临时描述', '1', 'null', '无名', '0.1', '1393038143', '0', '1', null);
...
INSERT INTO `wp_addons` VALUES ('54', 'Diy', '万能页面', '可以通过拖拉的方式配置一个3G页面', '1', 'null', '凡星', '0.1', '1397360521', '1', '1', '4');
...
CREATE TABLE `wp_attribute` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=783 DEFAULT CHARSET=utf8 COMMENT='模型属性表';
...
INSERT INTO `wp_attribute` VALUES ('108', 'keyword_length', '关键词长度', 'int(10) UNSIGNED  NULL', 'num', '0', '', '0', '', '5', '0', '1', '1398837058', '1393918566', '', '3', '', 'regex', '', '3', 'function');
...
INSERT INTO `wp_attribute` VALUES ('126', 'attach', '插件安装包', 'varchar(255)  NULL', 'file', '', '', '1', '', '17', '0', '1', '1394084870', '1394033674', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `wp_attribute` VALUES ('127', 'is_top', '置顶', 'int(10) NULL', 'num', '0', '0表示不置顶，否则其它值表示置顶且值是置顶的时间', '0', '0:不置顶\r\n1:置顶', '17', '0', '1', '1394068971', '1394068787', '', '3', '', 'regex', '', '3', 'function');
...
INSERT INTO `wp_attribute` VALUES ('650', 'title', '菜单名', 'varchar(50) NOT NULL', 'string', '', '可创建最多 3 个一级菜单，每个一级菜单下可创建最多 5 个二级菜单。编辑中的菜单不会马上被用户看到，请放心调试。', '1', '', '85', '0', '1', '1394519941', '1394518988', '', '3', '', 'regex', '', '3', 'function');
...
INSERT INTO `wp_attribute` VALUES ('218', 'title', '菜单名', 'varchar(50) NOT NULL', 'string', '', '可创建最多 3 个一级菜单，每个一级菜单下可创建最多 5 个二级菜单。编辑中的菜单不会马上被用户看到，请放心调试。', '1', '', '36', '0', '1', '1394519941', '1394518988', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `wp_attribute` VALUES ('219', 'pid', '一级菜单', 'tinyint(2) NULL', 'select', '0', '如果是一级菜单，选择“无”即可', '1', '0:无', '36', '0', '1', '1394519296', '1394518930', '', '3', '', 'regex', '', '3', 'function');
...
INSERT INTO `wp_attribute` VALUES ('550', 'keyword_type', '关键词类型', 'tinyint(2) NOT NULL', 'select', '0', '', '1', '0:完全匹配\r\n1:左边匹配\r\n2:右边匹配\r\n3:模糊匹配', '76', '1', '1', '1396624426', '1396061765', '', '3', '', 'regex', '', '3', 'function');
...
INSERT INTO `wp_attribute` VALUES ('557', 'finish_tip', '结束语', 'text NOT NULL', 'textarea', '', '为空默认为：考试完成，谢谢参与', '1', '', '76', '0', '1', '1396953940', '1396953940', '', '3', '', 'regex', '', '3', 'function');
...
INSERT INTO `wp_attribute` VALUES ('609', 'keyword', '关键词', 'varchar(100) NOT NULL', 'string', '', '', '1', '', '82', '1', '1', '1399038073', '1396061575', '', '3', '', 'regex', '', '3', 'function');
...
INSERT INTO `wp_attribute` VALUES ('612', 'intro', '封面简介', 'text NOT NULL', 'textarea', '', '', '1', '', '82', '0', '1', '1396624505', '1396061947', '', '3', '', 'regex', '', '3', 'function');
...
INSERT INTO `wp_attribute` VALUES ('618', 'url', '访问网址', 'varchar(255) NOT NULL', 'string', '', '为空则自动生成', '0', '', '82', '0', '1', '1398416321', '1397361414', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `wp_attribute` VALUES ('619', 'is_close', '是否关闭', 'tinyint(2) NOT NULL', 'bool', '0', '关闭后用户不能再访问该页面', '1', '0:开启\r\n1:关闭', '82', '0', '1', '1397361841', '1397361510', '', '3', '', 'regex', '', '3', 'function');
...
INSERT INTO `wp_attribute` VALUES ('622', 'view_count', '浏览数', 'int(10) UNSIGNED NOT NULL', 'num', '0', '', '0', '', '82', '0', '1', '1397475862', '1397475862', '', '3', '', 'regex', '', '3', 'function');
...
INSERT INTO `wp_attribute` VALUES ('654', 'module', '模块名', 'varchar(255) NOT NULL', 'string', 'Diy', '页面所属的模块', '0', '', '82', '0', '1', '1398350642', '1398350642', '', '3', '', 'regex', '', '3', 'function');
...
INSERT INTO `wp_attribute` VALUES ('696', 'uid', '管理员UID', 'int(10) NOT NULL', 'num', '', '可以在用户>用户信息页面的列表第一找到管理员的UID', '1', '', '90', '1', '1', '1398944756', '1398933236', '', '3', '', 'regex', '', '3', 'function');
...
INSERT INTO `wp_attribute` VALUES ('767', 'jump_url', '提交后跳转的地址', 'varchar(255) NOT NULL', 'string', '', '为空时不跳转', '1', '', '69', '0', '1', '1399800276', '1399800276', '', '3', '', 'regex', '', '3', 'function');
...
INSERT INTO `wp_config` VALUES ('46', 'SYSTEM_UPDATRE_VERSION', '0', '系统升级最新版本号', '4', '', '记录当前系统的版本号，这是与官方比较是否有升级包的唯一标识，不熟悉者只勿改变其数值', '1393764702', '1394337646', '1', '20140530', '0');
...
INSERT INTO `wp_hooks` VALUES ('17', 'weixin', '微信插件必须加载的钩子', '1', '1388810858', 'Vote,Chat,Wecome,UserCenter,HelloWorld,Robot,Suggestions,Extensions,Card,WeiSite,Hitegg,Leaflets,Xydzp,CustomReply,Forms,Survey,Exam,Test,Diy,Shop,CustomMenu,Coupon,Scratch,Juhe,Tongji');
...
INSERT INTO `wp_model` VALUES ('85', 'custom_menu', '自定义菜单', '0', '', '1', '', '1:基础', '', '', '', '', 'title:菜单名\r\nkeyword:关联关键词\r\nurl:关联URL\r\nsort:排序号\r\nid:操作:[EDIT]|编辑,[DELETE]|删除', '10', 'title', '', '1394518309', '1394720290', '1', 'MyISAM');
...
INSERT INTO `wp_model` VALUES ('34', 'weisite_cms', '文章管理', '0', '', '1', '{\"1\":[\"keyword\",\"keyword_type\",\"title\",\"intro\",\"cate_id\",\"cover\",\"content\"]}', '1:基础', '', '', '', '', 'keyword:关键词\r\nkeyword_type|get_name_by_status:关键词类型\r\ntitle:标题\r\ncate_id:所属分类\r\nsort:排序号\r\nview_count:浏览数\r\nid:操作:[EDIT]|编辑,[DELETE]|删除', '10', 'title', '', '1396061373', '1396510673', '1', 'MyISAM');
